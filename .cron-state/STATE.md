...
## STATUS: 📋 Ten release plans on disk — pipeline goes through v2.0.11; v2.0.2 SHIPPED to main

**Main HEAD**: `a063565` (v2.0.10 plan promotion). Will advance by 2 commits this tick (v2.0.11 plan + STATE chore).
